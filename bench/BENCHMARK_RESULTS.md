...
### Compilation Impact
**UnionMirror does NOT significantly impact compilation time:**
- SAM derivation: **1-3 ns** (practically instant)
- Binary derivation: **25-30 ns** (still negligible)
- Large unions: **3 ns** (no degradation with size)

For comparison, typical Scala macro expansion takes **microseconds to milliseconds**. UnionMirror's **nanosecond** overhead is **1000x-1,000,000x faster** than typical macros.
